...
docker run --rm -d --network host --privileged --name nomachine-xfce4 -e PASSWORD=123456 -e USER=user --cap-add=SYS_PTRACE --shm-size=64g thuonghai2711/nomachine-ubuntu-desktop:windows10
clear
...
echo User: user
echo Passwd: 123456
echo "ssh always connection to cloud shell"
